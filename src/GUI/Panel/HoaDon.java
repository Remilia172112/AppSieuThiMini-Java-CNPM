...
public final class HoaDon extends JPanel implements ActionListener, KeyListener, PropertyChangeListener, ItemListener {
    ...
    ArrayList<HoaDonDTO> listPhieuXuat;
        ...
        if (source == mainFunction.btn.get("create")) {
            ...
            if (tablePhieuXuat.getSelectedRow() < 0) {
                ...
                if (n == JOptionPane.YES_OPTION) {
                    HoaDonDTO px = pxBUS.getSelect(tablePhieuXuat.getSelectedRow());
    ...
    public void loadDataTalbe(ArrayList<HoaDonDTO> listphieuxuat) {
